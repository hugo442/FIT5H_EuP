...
class IterationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create iteration" do
    assert_difference('Iteration.count') do
      post iterations_url, params: { iteration: { description: @iteration.description, end_date: @iteration.end_date, project_id: @iteration.project_id, start_date: @iteration.start_date, title: @iteration.title } }
    end
  ...
  test "should update iteration" do
    patch iteration_url(@iteration), params: { iteration: { description: @iteration.description, end_date: @iteration.end_date, project_id: @iteration.project_id, start_date: @iteration.start_date, title: @iteration.title } }
